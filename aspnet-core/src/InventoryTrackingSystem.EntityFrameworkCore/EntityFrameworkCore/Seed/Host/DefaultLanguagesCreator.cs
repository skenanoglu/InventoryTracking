...
namespace InventoryTrackingSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly InventoryTrackingSystemDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = InventoryTrackingSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(InventoryTrackingSystemDbContext context)
        {
            _context = context;
        }
