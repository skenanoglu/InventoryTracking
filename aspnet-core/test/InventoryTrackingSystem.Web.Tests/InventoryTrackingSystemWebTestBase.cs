...
{
    public abstract class InventoryTrackingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InventoryTrackingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InventoryTrackingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InventoryTrackingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InventoryTrackingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InventoryTrackingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InventoryTrackingSystemDbContext, Task<T>> func)
        {
            T result;
